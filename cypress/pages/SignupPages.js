class SignupPage {
    go(){
         // cy.viewport(1440,900) - foi tranferido para o arquido de configuração do cypress
        cy.visit('/') // no arquivo de configuração tambem foi colocado a página basica baseUrl
